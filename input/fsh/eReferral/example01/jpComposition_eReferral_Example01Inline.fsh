...
* encounter.reference = "urn:uuid:666cacd1-c1d4-4fdd-bea4-0409629f8027"
...
* section[=].entry[+].reference = "urn:uuid:b76b3456-68ad-4759-9c20-e07e09df52c9"
...
* section[=].entry[+].reference = "urn:uuid:595a7cae-3894-449f-94ff-6ee989825c41"
* section[=].entry[=].type = "Organization"
* section[=].entry[=].display = "紹介先診療科"


// * section[=].entry[+].reference = "referralToPractitionerExample01Inline"
* section[=].entry[+].reference = "urn:uuid:c4b0c04f-9331-4fe1-9afb-932afd8b6b83"
...
* section[=].entry[+].reference = "urn:uuid:9d9fc0bd-2839-47d8-8b1a-0d145df9a4ae"
* section[=].entry[=].type = "Organization"
* section[=].entry[=].display = "紹介元医療機関"


// * section[=].entry[+].reference = "referralFromOrganizationDeptExample01Inline"
* section[=].entry[+].reference = "urn:uuid:4732cd90-71ef-4f8a-8549-7027fe0b4236"
* section[=].entry[=].type = "Organization"
* section[=].entry[=].display = "紹介元診療科"


// * section[=].entry[+].reference = "referralFromPractitionerExample01Inline"
* section[=].entry[+].reference = "urn:uuid:d99cbf9b-fbcf-4eab-9c72-8804cebe85ec"
* section[=].entry[=].type = "Practitioner"
...
* section[=].section[=].entry[+].reference = "urn:uuid:b338fe1f-7464-45be-a2e9-7c461db14591"
...
* section[=].section[=].entry[+].reference = "urn:uuid:b9f0f06c-177b-405a-a383-6f01a548dd16"
...
* section[=].section[=].entry[+].reference = "urn:uuid:e8358718-ba6e-4aab-bddd-67d323eb9f44"
* section[=].section[=].entry[=].type = "Condition"
* section[=].section[=].entry[=].display = "傷病名・主訴"
...
* section[=].section[=].entry[+].reference = "urn:uuid:7e267642-6662-4f6a-821e-1a743140fe49"
* section[=].section[=].entry[=].type = "Condition"
...
* section[=].section[=].entry[+].reference = "urn:uuid:54764f12-6227-4b17-bddc-ae289119920d"
* section[=].section[=].entry[=].type = "Condition"
* section[=].section[=].entry[=].display = "既往歴"
// * section[=].section[=].entry[+].reference = "ph2ReferralExample01Inline"
* section[=].section[=].entry[+].reference = "urn:uuid:9d2f9a9d-9dab-478c-a0ec-6dddbf07d3fb"
* section[=].section[=].entry[=].type = "Condition"
* section[=].section[=].entry[=].display = "既往歴"
...
* section[=].section[=].entry[+].reference = "urn:uuid:ff9adfca-bf93-413a-8671-dd6de2a5654f"
...
* section[=].section[=].entry[+].reference = "urn:uuid:a304f316-e47a-4240-ae70-34da3e75719e"
* section[=].section[=].entry[=].type = "AllergyIntolerance"
* section[=].section[=].entry[=].display = "アレルギー・不耐性反応"
...
* section[=].section[=].entry[+].reference = "urn:uuid:3758edce-3fd0-414a-be35-226a8742a6bb"
...
* section[=].section[=].entry[+].reference = "urn:uuid:2318e40f-3eac-4d98-949b-b82346ff47cc"
...
* section[=].section[=].entry[+].reference = "urn:uuid:8f48f39e-fef0-4c22-becb-df12f65f55c5"
* section[=].section[=].entry[=].type = "MedicationRequest"
* section[=].section[=].entry[=].display = "投薬指示"
...
* section[=].section[=].entry[+].reference = "urn:uuid:1d1a8866-2351-4c3b-890c-67e6b639d364"
