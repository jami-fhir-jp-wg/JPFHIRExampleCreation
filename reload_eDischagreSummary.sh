targetProject=eDisSummary
targetPackage=jp-edissummary#0.9.0-snap.tgz
targetFile=Bundle-bundleDisSummaryExample01.json
#
...
done < <(find ./fshegg/$targetProject -name *.fshegg )
